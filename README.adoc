...
image:https://images.microbadger.com/badges/version/kalemena/docker-node-red/master.svg[Docker Version, link=https://hub.docker.com/r/kalemena/node-red/tags]
endif::[]
